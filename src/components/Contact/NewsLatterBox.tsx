...
const NewsLatterBox = () => {
  ...
  return (
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-xl  sm:p-11 lg:p-8 xl:p-11 h-[97%]">
      ...
      <div>
        <input
          ...
          className="border-stroke mb-4 w-full rounded-sm border bg-[#f8f8f8] px-6 py-3 text-base text-body-color outline-none focus:border-mainColor  "
          autoComplete="off"
        />
        <input
          type="email"
        ...
        <input
          type="submit"
          value="Subscribe"
          className="mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-mainColor px-9 py-4 text-base font-medium text-white shadow-submit duration-300 hover:bg-mainColor/90 "
        />
