...
export default function BlogPostPage({ slugname }) {
  const [post, setPost] = useState(null);
  const [metadata, setMetadata] = useState(metaTags[slugname] || {
  ...
  useEffect(() => {
    // Simulate fetching the blog data based on the slug
    const fetchPost = async () => {
      // Replace with actual blog data fetching logic, like an API call
      const foundPost = blogData.find((p) => p.slugname === slugname);
      console.log(foundPost)
      setPost( foundPost || `<div className="container mx-auto mt-[10rem] grid min-h-[80vh] place-items-center text-black">
        <p>No Post Found</p>
      </div>`);
    };
  ...
  return (
    ...
    <Helmet>
      ...
      <div className="container mx-auto mt-[10rem] min-h-screen text-black">
        ...
        <div dangerouslySetInnerHTML={{ __html: post?.content ? post?.content : post }}>
