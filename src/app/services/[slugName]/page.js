...
export default async function ServicePostPage({ params }) {
  const post = serviceData.find((p) => p.slugName === params.slugName);
  ...
  return (
    <div className="container mx-auto mt-[10rem] min-h-screen text-black">
      <div className="flex w-full justify-end">
        <Link
          href="https://desktopvaluation.in/"
          className="rounded-lg bg-green-600 p-2 text-center text-white transition duration-300 hover:bg-green-800"
        >
