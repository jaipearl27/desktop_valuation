...
const SigninPage = () => {
  const { setToken, refetchUserData } = useContext(UserContext);
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded bg-white px-6 py-10 shadow-three  sm:p-[60px]">
                ...
                <button
                  ...
                  className="mt-4 flex w-full items-center justify-center rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600"
                >
